			...
			<nav id="sidebarStudent" class="active">
				<div class="container"><br>
					...
					<form action="{{URL::to('/storestud')}}" class="form-signup2" method="post">
							...
							<div class="row">
								<div class="col-md-8 offset-md-2">
									<button type="submit" id="signupstudent" class="btn btn-purple btn-signup float-right">Sign Up</button>
								</div>
							</div>
						</form><br>
						...
						$("#signupstudent").click(function () {
							...
							var confirmPassword = $("#passwordstudentconfirm").val();
							var terms = $("#defaultCheck:checked").val();
			...
			<nav id="sidebarOrganization" class="active">
				<div class="container"><br>
					...
					<div class="card-margin-inside">
						...
						<div class="row">
							...
							<label class="btn">
								<div class="circle-insertlogo">
									...
									<input type="file" class="inputfile" id="logofile">
									</h1>
								</div>
							</label>
							</div>
						...
						<div class="row">
							<div class="col-md-8 offset-md-2">
								<div class="form-group form-group-signup row">
									...
									<div class="col-sm-9">
										<input class="form-control form-signup" type="text" id="organization">
									</div>
								</div>
							</div>
						</div><br>
						...
						<div class="row">
							<div class="col-md-8 offset-md-2">
								<button class="btn btn-purple btn-signup float-right" id="signuporganization">Sign Up</button>
							</div>
						</div>
						</form><br>
						<script type="text/javascript">
